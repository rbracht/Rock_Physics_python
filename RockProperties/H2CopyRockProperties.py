...
def dryFrameModuliChangeWithPressure( Pnew, Pref, Kref, MuRef, PhiRef, Kmatrix, MuMatrix, scaleK=1.0, scaleMu=1.0 , **kwargs):
	"""
	...
	Kref          bulk modulus at reference state               (Gpa)
	...
	KhmP1 = dteSeventhModifiedHertzMindlinSpherePackEffectiveBulkModulus( P1, P0, KhmP0, sK )
	MuHmP1 = dteSeventhModifiedHertzMindlinSpherePackEffectiveShearModulus( KhmP1,  Mu0, K0, sMu, sK )
...
def gassmannModeling( initWaterSat, finalWaterSat, 
	...
	if alterDryFrameMod != 1:
		...
		final_K_dry,final_Mu_dry = dryFrameModuliChangeWithPressure( finalEffectiveP,
									     ...
									     Kmatrix,
									     MuMatrix,
									     scaleK = dryFrameScale,
									     scaleMu = dryFrameScale )
