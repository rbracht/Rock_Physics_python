...
def dryFrameModuliChangeWithPressure( Pnew, Pref, Kref, MuRef, PhiRef, Kmatrix, MuMatrix, scaleK=1.0, scaleMu=1.0 , printVar=0, **kwargs):
	"""
...
def gassmannModeling( initWaterSat, finalWaterSat, 
	...
	if alterDryFrameMod != 1:
		...
		final_K_dry,final_Mu_dry = dryFrameModuliChangeWithPressure( finalEffectiveP,
									     ...
									     Kmatrix,
									     MuMatrix,
									     scaleK = dryFrameKScale,
									     scaleMu = dryFrameMuScale )
